...
3.	Enter values of <i>a, b</i> and <i>c</i> as suggested there and click on “Submit” button to get the solution.
...
9.	Drag the sliders to choose <i>R, L</i> and <i>C</i>. Observe that the corresponding values are changing in the given circuit.
