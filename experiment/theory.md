...
Using given initial conditions, we obtain <i>c</i><sub>1</sub>+<i>c</i><sub>2</sub>=<i>Q</i>(0)=1 and (−50+15 </span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>1</sub>+(−50-15 </span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>2</sub>=<i>Q′</i>(0)=2. Therefore <i>c</i><sub>2</sub>=0.285 and <i>c</i><sub>1</sub>=0.715. Thus <i>Q</i>=0.715<i>e</i></span>$^{(−50+15 \sqrt{10}t)} $<span style="font-family: 'Times New Roman'; font-size: 22px;"> +0.285<i>e</i></span>$ ^{(−50-15 \sqrt{10}​t)}$<span style="font-family: 'Times New Roman'; font-size: 22px;">. <br>
Required current <i>I</i>≡<i>dQ</i>/<i>dt</i>=(−50+15 </span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>).(0.715)<i>e</i></span> $^{(−50+15 \sqrt{10} t)}$ <span style="font-family: 'Times New Roman'; font-size: 22px;">+(−50-15</span>$ \sqrt{10} $<span style="font-family: 'Times New Roman'; font-size: 22px;">t).(0.285) <i>e</i></span>$^{(−50-15 \sqrt{10}t)}. $​ </span>
