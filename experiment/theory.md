...
The given differential equation reduces to 2<i>Q′′</i>+200<i>Q′</i>+500<i>Q</i>=0. The auxiliary equation of the given differential equation is 2<i>m</i><sup>2</sup>+200<i>m</i>+500=0. Thus <i>m</i>=(−50+15<span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"><i>t</i>) or (−50-15 $ \sqrt{10} $ <i>t</i>). Therefore the complete integral of the given differential equation is     <br>                                                 
                      <i>Q</i>=<i>c</i><sub>1</sub><i>e</i><sup>(−50+15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)</sup>+<i>c</i><sub>2</sub><i>e</i><sup>(−50-15 $ \sqrt{10}​ $<i>t</i>)</sup>,                      …(<i>i</i>) <br>
where <i>c</i><sub>1</sub>, <i>c</i><sub>2</sub> are constants. Now differentiating equation (<i>i</i>) yields  <br>
                           <i>Q′</i>=(−50+15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>1</sub><i>e</i><sup>(−50+15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)</sup>+(−50-15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>2</sub><i>e</i><sup>(−50-15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)</sup>,           … (<i>ii</i>)  <br>
Using given initial conditions, we obtain <i>c</i><sub>1</sub>+<i>c</i><sub>2</sub>=<i>Q</i>(0)=1 and (−50+15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>1</sub>+(−50-15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>2</sub>=<i>Q′</i>(0)=2. Therefore <i>c</i><sub>2</sub>=0.285 and <i>c</i><sub>1</sub>=0.715. Thus <i>Q</i>=0.715<i>e</i><sup>(−50+15 $ \sqrt{10} $ ​<i>t</i>)</sup>+0.285<i>e</i><sup>(−50-15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)</sup>. Required current <i>I</i>≡<i>dQ</i>/<i>dt</i>=(−50+15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>).(0.715)<i>e</i><sup>(−50+15 $ \sqrt{10} $ ​<i>t</i>)</sup>+(−50-15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>).(0.285)<i>e</i><sup>(−50-15 <span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)</sup>.</span>
