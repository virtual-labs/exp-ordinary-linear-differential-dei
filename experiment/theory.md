...
where <i>c</i><sub>1</sub>, <i>c</i><sub>2</sub> are constants. Now differentiating equation (<i>i</i>) yields  <br>
                           <i>Q′</i>=(−50+15 </span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>1</sub><i>e</i> $ ^{(−50+15 \sqrt{10} t)​ +(−50-15 \sqrt{10}t)}$​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>c</i><sub>2</sub><i>e</i>$ ^{(−50-15 \sqrt{10}t)}$​ <span style="font-family: 'Times New Roman'; font-size: 22px;">,           … (<i>ii</i>)  <br>
