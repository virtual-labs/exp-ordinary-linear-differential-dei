...
The given differential equation reduces to 2<i>Q′′</i>+200<i>Q′</i>+500<i>Q</i>=0. The auxiliary equation of the given differential equation is 2<i>m</i><sup>2</sup>+200<i>m</i>+500=0. Thus <i>m</i>=(−50+15</span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"><i>t</i>) or (−50-15</span> $ \sqrt{10} $ <span style="font-family: 'Times New Roman'; font-size: 22px;"><i>t</i>). Therefore the complete integral of the given differential equation is     <br>                                                
                      <i>Q</i>=<i>c</i><sub>1</sub><i>e</i></span> $ ^{(−50+15 \sqrt{10}t)} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;">+<i>c</i><sub>2</sub><i>e</i></span> $^{(−50-15 \sqrt{10}​ t)}, $                      <span style="font-family: 'Times New Roman'; font-size: 22px;">    … (<i>i</i>) <br>
where <i>c</i><sub>1</sub>, <i>c</i><sub>2</sub> are constants. Now differentiating equation (<i>i</i>) yields  <br>
                           <i>Q′</i>=(−50+15 </span> $ \sqrt{10} $​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>1</sub><i>e</i></span> $ ^{(−50+15 \sqrt{10} t)​} $<span style="font-family: 'Times New Roman'; font-size: 22px;">+(−50-15</span> $ \sqrt{10}$​ <span style="font-family: 'Times New Roman'; font-size: 22px;"> <i>t</i>)<i>c</i><sub>2</sub><i>e</i></span>$ ^{(−50-15 \sqrt{10}t)}$​ <span style="font-family: 'Times New Roman'; font-size: 22px;">,           … (<i>ii</i>) <br>
